...
这是一个面向高中学生与校友的校园服务与交流网站。项目从静态学习工具起步，现已扩展为包含论坛后端、Neon 数据库、Render API、Doubao / Ark AI 助手“小和”，以及 Netlify / GitHub Pages 双前端部署的完整 MVP。
...
- 小和：右下角 AI Agent，可回答网站功能、搜索资源和论坛、推荐标签、生成发帖草稿。
